...
namespace AnomalyLab.Backend
{
    public class APIManager : MonoBehaviour
    {
        ...
        {
            string formattedLink = string.Format(envCache.master + urllogin, envCache.code);
        ...
        protected IEnumerator TriggerAuthDataIE(Action<UserDataResponse> nextAction = null)
        {
            ...
            Debug.Log("Auth link: " + formattedLink);
            UnityWebRequest request = UnityWebRequest.Get(formattedLink);
            yield return request.SendWebRequest();
        ...
        protected IEnumerator IESendBet(string data, Action<bool, string> onReturn = null)
        {
            ...
            {
                Debug.Log("Bet link: " + envCache.game + urlSendBet);
                ...
                if (www.result != UnityWebRequest.Result.Success)
                {
                    ...
                    onReturn?.Invoke(false, www.downloadHandler.text);
        ...
        protected IEnumerator IEUpdateSettings(string data, Action<bool, string> onReturn = null)
        {
            ...
            {
                Debug.Log("settings link: " + envCache.game + urlSettings);
                www.downloadHandler = new DownloadHandlerBuffer();
                yield return www.SendWebRequest();
        ...
        protected void Start()
        {
            ...
            //StartCoroutine(IEnumReadEnv(OnStartReturn));
        }
    }
}
